...
/**
 * Eenvoudige in-memory opslag van entiteiten zoals passagiers, reizen, treinen en tickets.
 * Wordt gebruikt als coördinator om objecten te koppelen via de CLI-flow.
 */
